...
- Automatic plans default to `thinking=true`, `enable_thinking=true`, and `reasoning_effort=high`; explicit `model_overrides.chat_template_kwargs` remains authoritative for model-specific templates.
