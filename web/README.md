...
Start it with Python 3.11+ from the \`Automation\` directory or repository root:

    python3.11 -m web.server --host 0.0.0.0 --port 18080

or:

    python3.11 Automation/web/server.py --host 0.0.0.0 --port 18080
